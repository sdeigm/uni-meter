...
public class Pulse extends HttpInputDevice {
  ...
  static final byte[] POWER_1_7_BYTES = new byte[] {0x01, 0x00, 0x01, 0x07, 0x00, (byte) 0xFF };
  static final byte[] POWER_2_7_BYTES = new byte[] {0x01, 0x00, 0x02, 0x07, 0x00, (byte) 0xFF };
  static final byte[] POWER_16_7_BYTES = new byte[] {0x01, 0x00, 0x10, 0x07, 0x00, (byte) 0xFF };
  static final byte[] POWER_21_7_BYTES = new byte[] {0x01, 0x00, 0x15, 0x07, 0x00, (byte) 0xFF };
  static final byte[] POWER_22_7_BYTES = new byte[] {0x01, 0x00, 0x16, 0x07, 0x00, (byte) 0xFF };
  static final byte[] POWER_41_7_BYTES = new byte[] {0x01, 0x00, 0x29, 0x07, 0x00, (byte) 0xFF };
  static final byte[] POWER_42_7_BYTES = new byte[] {0x01, 0x00, 0x2A, 0x07, 0x00, (byte) 0xFF };
  static final byte[] POWER_61_7_BYTES = new byte[] {0x01, 0x00, 0x3D, 0x07, 0x00, (byte) 0xFF };
  static final byte[] POWER_62_7_BYTES = new byte[] {0x01, 0x00, 0x3E, 0x07, 0x00, (byte) 0xFF };
  static final byte[] POWER_36_7_BYTES = new byte[] {0x01, 0x00, 0x24, 0x07, 0x00, (byte) 0xFF };
  static final byte[] POWER_56_7_BYTES = new byte[] {0x01, 0x00, 0x38, 0x07, 0x00, (byte) 0xFF };
  ...
  private boolean checkFor21_7to61_7(@NotNull SmlGetListRes response) {
    ...
    Double expPowerL2 = findEntry(POWER_42_7_BYTES, response);
    Double impPowerL3 = findEntry(POWER_61_7_BYTES, response);
    Double expPowerL3 = findEntry(POWER_62_7_BYTES, response);
